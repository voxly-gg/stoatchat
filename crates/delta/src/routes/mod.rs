...
fn custom_openapi_spec() -> OpenApi {
    ...
    extensions.insert(
        "x-logo".to_owned(),
        json!({
            "url": "https://voxly.gg/header.png",
            "altText": "Voxly Header"
        }),
    );
    ...
    OpenApi {
        ...
        info: Info {
            title: "Voxly API".to_owned(),
            description: Some("Open source user-first chat platform.".to_owned()),
            terms_of_service: Some("https://voxly.gg/terms".to_owned()),
            contact: Some(Contact {
                name: Some("Voxly Support".to_owned()),
                url: Some("https://voxly.gg".to_owned()),
                email: Some("contact@voxly.gg".to_owned()),
                ..Default::default()
            }),
            license: Some(License {
                name: "AGPLv3".to_owned(),
                url: Some("https://github.com/voxly-gg/stoatchat/blob/master/LICENSE".to_owned()),
                ..Default::default()
            }),
        ...
        servers: vec![
            Server {
                url: "https://voxly.gg/api".to_owned(),
                description: Some("Voxly Production".to_owned()),
                ..Default::default()
            },
            Server {
                url: "https://dev.voxly.gg/api".to_owned(),
                description: Some("Voxly Staging".to_owned()),
                ..Default::default()
            },
            Server {
                url: "http://localhost:14702".to_owned(),
                description: Some("Local Voxly Environment".to_owned()),
                ..Default::default()
            },
            Server {
                url: "http://localhost:14702/0.8".to_owned(),
                description: Some("Local Voxly Environment (v0.8)".to_owned()),
                ..Default::default()
            },
        ],
        external_docs: Some(ExternalDocs {
            url: "https://developers.voxly.gg".to_owned(),
            description: Some("Voxly Developer Documentation".to_owned()),
            ..Default::default()
        }),
        extensions,
        tags: vec![
            Tag {
                name: "Core".to_owned(),
                description: Some(
                    "Use in your applications to determine information about the Voxly node"
                        .to_owned(),
                ),
                ..Default::default()
            },
            Tag {
                ...
                description: Some("Query and fetch users on Voxly".to_owned()),
                ..Default::default()
            },
            Tag {
                name: "Direct Messaging".to_owned(),
                description: Some("Direct message other users on Voxly".to_owned()),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some("Query and fetch channels on Voxly".to_owned()),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some("Query and fetch servers on Voxly".to_owned()),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some(
                    "After signing up to Voxly, users must pick a unique username".to_owned(),
                ),
                ..Default::default()
            },
            Tag {
            ...
            Tag {
                ...
                description: Some(
                    "Subscribe to and receive Voxly push notifications while offline".to_owned(),
                ),
                ..Default::default()
            },
            Tag {
